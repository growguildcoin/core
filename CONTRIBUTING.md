Contributing to MentaCoin Core
============================

The MentaCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the MentaCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/mentacoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to mentacoin-qt
...
The following applies to code changes to the MentaCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall MentaCoin
Network Protocol consensus changes.

Whether a pull request is merged into MentaCoin Core rests with the project merge
...
Patches that change MentaCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the MentaCoin consensus, it must have been
...
The project leader is the release manager for each MentaCoin Core release.
